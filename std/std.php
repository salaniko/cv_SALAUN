...
require_once("std/strfun.php") ; # <== fonctions usuelles pour chaines de caractères
...
echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"std/std.css\"  title=\"gh\" />\n" ;
...
function td($aligne="L",$cla="",$colspan="",$xtra="",$sdl=1) {
  $defcla = "" ;
  if (strlen($cla)>0)     { $defcla  = " class='$cla'" ; } ;
...
function ghVert($chen) {
  return("<span class=\"gvert\">$chen</span>") ;
